...
searchReturnButton?.addEventListener?.("click",()=>{if(launcherReturnPending&&!searchReturn){clearLauncherReturn();globalThis.__POLICE_LAUNCHER_OPEN?.({restore:true});return}restoreSearchReturn()});
