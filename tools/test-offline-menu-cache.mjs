...
match(index, /id="pwaInstall"/);
match(index, /id="pwaTitle">Jak zainstalować<\/span>/);
...
match(offline, /beforeinstallprompt/);
match(offline, /appinstalled/);
match(offline, /navigator\.standalone===true/);
match(offline, /Udostępnij → Dodaj do ekranu początkowego → Dodaj/);
